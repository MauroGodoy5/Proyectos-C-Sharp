<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modificacionpelicula.aspx.cs" Inherits="desempeño2.modificacionpelicula" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSourcepeliculas" runat="server" ConnectionString="<%$ ConnectionStrings:peliculasConnectionString %>" SelectCommand="SELECT * FROM [PELICULAS]" UpdateCommand="UPDATE PELICULAS SET nombre_pelicula = @nombre_pelicula, web_pelicula = @web_pelicula, descripcion = @descripcion, id_genero = @Id_genero, anio = @anio, archivo = @archivo WHERE (id_pelicula = @Id_pelicula)">
                <UpdateParameters>
